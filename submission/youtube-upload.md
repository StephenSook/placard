...
| What | Path |
|---|---|
| Video (UPLOAD THIS) | `video/film/out/placard-final-1080.mp4` |
| Subtitles, English | `video/film/out/placard.srt` |
| Custom thumbnail | `video/film/out/thumbnail.jpg` |

The 4K master was abandoned: two renders truncated, the second one silently, and
the codec-tier gain was not worth a third attempt on footage captured at
1600x1000 that could not carry 4K anyway. The 1080p master is fully verified,
4952 video packets, 0.19s stream drift, and watched end to end.
